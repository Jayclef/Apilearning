const global = {
  ...
  api: {
    apiKey: "4be8b648663a918a5248aacb04391695",
...
async function displayMoviesDetails() {
  ...
  const movies = await fetchAPIData(`movie/${movieId}`);

  //overlay for background image
  displayBackgroundImage("movies", movies.backdrop_path);
  ...
  div.innerHTML = `
      <div class="details-top">
          ...
          <div>
            ...
            <p class="text-muted">Release Date: ${movies.release_date}</p>
            <p>
            ${movies.overview}
            </p>
            <h5>Genres</h5>
        ...
        <div class="details-bottom">
          ...
          <ul>
            ...
            <li><span class="text-secondary">Status: ${
              movies.status
            }</span> Released</li>
          </ul>
